...
public class RecyleKol extends RecyclerView.Adapter<RecyleKol.ViewHolder>{
    ...
    RecyleKol(Context context, List<String> data, List<String> Judul, List<String> Genre, List<String> Penulis) {
