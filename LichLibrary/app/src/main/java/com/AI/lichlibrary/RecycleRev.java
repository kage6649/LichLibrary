...
public class RecycleRev extends RecyclerView.Adapter<RecycleRev.ViewHolder> {
    private List<String> mData,Bgen,Bpen,Bjdl;
    private LayoutInflater mInflater;
    private RecyleBook.ItemClickListener mClickListener;

    // data is passed into the constructor
    RecycleRev(Context context, List<String> data,List<String> Judul,List<String> Genre,List<String> Penulis) {
...
//        String uri = Bpen.get(position);
        ...
        holder.Gen.setText("Username : "+gen);
        holder.Pen.setText("Rating : "+pen);
