...
public class RecyleBoking extends RecyclerView.Adapter<RecyleBoking.ViewHolder>{
    private List<String> mData,Bgen,Bpen,Bjdl;
    private LayoutInflater mInflater;
    private RecyleBook.ItemClickListener mClickListener;

    // data is passed into the constructor
    RecyleBoking(Context context, List<String> data, List<String> Judul, List<String> Genre, List<String> Penulis) {
...
//        String animal = mData.get(position);
        ...
        holder.Gen.setText("Masa Pinjam : "+gen+" hari");
        holder.Pen.setText("Status : "+pen);
        holder.log.setImageResource(R.drawable.baseline_bookmark_add_24_wh);
    }
