...
public class RecyleKembali extends RecyclerView.Adapter<RecyleKembali.ViewHolder>{
    private List<String> mData,Bgen,Bpen,Bjdl;
    private LayoutInflater mInflater;
    private RecyleBook.ItemClickListener mClickListener;
    RecyleKembali(Context context, List<String> data, List<String> Judul, List<String> Genre, List<String> Penulis) {
...
//        String animal = mData.get(position);
        ...
        holder.Gen.setText("Pengembalian : "+gen);
        holder.Pen.setText("Denda : "+pen);
        holder.log.setImageResource(R.drawable.baseline_bookmark_added_24_wh);
    }
