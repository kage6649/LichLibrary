...
public class ListReview extends AppCompatActivity implements RecycleRev.ItemClickListener{
...
//        Toast.makeText(this, "You clicked " + adapterReview.getItem(position) + " on row number " + position, Toast.LENGTH_SHORT).show();
    }
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        int itemId = item.getItemId();
        if (itemId==R.id.card){
//            Toast.makeText(this, "card", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(ListReview.this,UserCard.class);
...
//            Toast.makeText(this, "pinjam", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(ListReview.this, Pinjam.class);
            startActivity(intent);
            finish();
            return true;
        } else if (itemId==R.id.kembali) {
//            Toast.makeText(this, "kembali", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(ListReview.this, Kembali.class);
            startActivity(intent);
            finish();
            return true;
            ...
            String cek = DB.cek();
            DB.delLog(cek);
            Intent intent = new Intent(ListReview.this, Login.class);
            startActivity(intent);
            finish();
            return true;
            ...
            Intent intent = new Intent(ListReview.this, Home.class);
            startActivity(intent);
            finish();
            return true;
        } else {
...
//        Log.v("ok",data1.toString()+"\n"+data2.toString()+"\n"+data3.toString()+"\n"+data4.toString());
        ...
        RecyclerView recyclerView = findViewById(R.id.listReview);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapterReview = new RecycleRev(this, data1,data2,data3,data4);
        adapterReview.setClickListener(this::onItemClick);
...
//                Log.v("oke",data1+"\n"+data2+"\n"+data3+"\n"+data4+"\n"+x);
                ...
                try {
                    Intent intent = new Intent(ListReview.this, ListViewKol.class);
